...
const loadBookingDetails = async () => {
  ...
  try {
    // TODO: 替換為實際的 API 調用
    // const response = await fetch(`/api/grooming-bookings/${bookingId}`);
...
const loadHistoryBookings = async () => {
  try {
    // TODO: 替換為實際的 API 調用
    // const response = await fetch(`/api/customers/${booking.value.customer_id}/grooming-history`);
    // const data = await response.json();
    ...
    historyBookings.value = [
      ...
      },
      {
        ...
        service_type: '造型服務',
        service_description: '包含洗毛、吹乾、修剪造型',
        duration: '約90分',
        price: 1200,
        store_note: '小型犬，容易緊張但可控制\n配合度佳，洗澡完成高\n下次可嘗試縮短修毛時間'
      }
            ...
            <div class="history-container">
              ...
              >
                ...
                <div class="history-service">
                  ...
                  <p>說明：{{ history.service_description }}</p>
...
<style scoped src="../../../../styles/pages/Stores/Booking/Grooming/details.css"></style>