      ...
      <div class="addposts-form-content">
        <div>
          ...
          <div class="addposts-radio-group">
            <label class="addposts-radio-item"><input type="radio" name="service" value="美容" class="mr-1" /> 美容</label>
            <label class="addposts-radio-item"><input type="radio" name="service" value="住宿" class="mr-1" /> 住宿</label>
          </div>
        </div>
        <div>
          <label class="addposts-label">標籤</label>
          <div class="addposts-checkbox-grid">
            <label class="addposts-checkbox-item"><input type="checkbox" value="毛孩日常" class="mr-1" /> 毛孩日常</label>
            <label class="addposts-checkbox-item"><input type="checkbox" value="毛孩美容" class="mr-1" /> 毛孩美容</label>
            <label class="addposts-checkbox-item"><input type="checkbox" value="毛孩造型" class="mr-1" /> 毛孩造型</label>
            <label class="addposts-checkbox-item"><input type="checkbox" value="毛孩保養" class="mr-1" /> 毛孩保養</label>
            <label class="addposts-checkbox-item"><input type="checkbox" value="毛孩知識" class="mr-1" /> 毛孩知識</label>
            <label class="addposts-checkbox-item"><input type="checkbox" value="其他" class="mr-1" /> 其他</label>
          </div>
        </div>
        <div>
